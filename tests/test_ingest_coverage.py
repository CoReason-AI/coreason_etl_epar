...
def test_epar_index_hash_failure() -> None:
...
def test_spor_organisations_hash_failure() -> None:
...
def test_epar_index_read_excel_failure() -> None:
...
def test_spor_zip_processing_failure() -> None:
